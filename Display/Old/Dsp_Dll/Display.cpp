...
DSP_DLL_API  START( long numsamples, long *preferredchunksize, void **ref )
{
    DLLSTATE    *ps;
...
DSP_DLL_API  INITPARAMS( void **parameters, long *paramsize )
{
    if( *paramsize==0 )
    {
        DspPar = DefaultPar;
...
DSP_DLL_API  ANALYZE( void *ref, long numsamples, short *data )
{
...
DSP_DLL_API   USERUI( void *ref, char *parameters, HWND parent )
{
...
DSP_DLL_API  DISPLAY( void *ref, HDC paintDC, long startsample, long endsample,
